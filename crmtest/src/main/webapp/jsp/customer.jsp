...
<body>
	...
	<div id="wrapper">
		...
		<div class="navbar-header">
			...
			<a class="navbar-brand" href="index.html">贷款管理系统</a>
		</div>
		<!-- /.navbar-header -->
			...
			<div class="sidebar-nav navbar-collapse">
				<ul class="nav" id="side-menu">
					...
					<li><a href="customer.action" class="active"><i
							class="fa fa-edit fa-fw"></i> 我的客户</a>
						<ul class="nav nav-list nav-child">
							<li><a href="#"><span class="icon-left glyphicon glyphicon-home" aria-hidden="true"></span><span>新客户</span></a></li>
							<li><a href="#"><span class="icon-left glyphicon glyphicon-home" aria-hidden="true"></span><span>再分配客户</span></a></li>
							<li><a href="#"><span class="icon-left glyphicon glyphicon-home" aria-hidden="true"></span><span>所有客户</span></a></li>
							<li><a href="#"><span class="icon-left glyphicon glyphicon-home" aria-hidden="true"></span><span>收藏夹</span></a></li>
							<li><a href="#"><span class="icon-left glyphicon glyphicon-home" aria-hidden="true"></span><span>今日预约</span></a></li>
						</ul>
					</li>
					<li><a href="salevisit.action"><i
							class="fa fa-dashboard fa-fw"></i> 签约进件</a></li>
                    <li><a href="salevisit.action"><i
                            class="fa fa-dashboard fa-fw"></i> 组织管理</a></li>
                    <li><a href="salevisit.action"><i
