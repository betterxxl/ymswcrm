...
import com.ymsw.common.exception.job.TaskException;
import com.ymsw.common.utils.poi.ExcelUtil;
import com.ymsw.quartz.domain.SysJob;
import com.ymsw.quartz.service.ISysJobService;
...
public class SysJobController extends BaseController
{
    ...
    public String job()
    {
        return prefix + "/templates.monitor.job";
    }
    ...
    public String detail(@PathVariable("jobId") Long jobId, ModelMap mmap)
    {
        ...
        mmap.put("templates.monitor.job", jobService.selectJobById(jobId));
    ...
    @RequiresPermissions("monitor:templates.monitor.job:changeStatus")
    ...
    @RequiresPermissions("monitor:templates.monitor.job:add")
    @PostMapping("/add")
    @ResponseBody
     ...
     */
    @Log(title = "定时任务", businessType = BusinessType.UPDATE)
    @RequiresPermissions("monitor:templates.monitor.job:edit")
    @PostMapping("/edit")
    @ResponseBody
